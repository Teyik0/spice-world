  ...
  ({ id, name, ["bind:checked"]: checkedSig, checked, onInput$, ...props }) => {
    ...
    return (
      <input
        ...
        class={cn(
          "peer cursor-pointer h-4 w-4 shrink-0 border-primary text-primary accent-primary ring-offset-background focus:ring-ring focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-50",
          props.class,
        )}
        id={inputId}
      />
