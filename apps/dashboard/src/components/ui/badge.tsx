...
export const badgeVariants = cva(
	"inline-flex items-center rounded-sm px-2.5 py-0.5 font-semibold text-xs shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
	{
		variants: {
			look: {
